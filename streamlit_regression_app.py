...
gender = st.selectbox('Gender', label_encoder_gender.classes_)  # Display "Male" and "Female"
age = st.slider('Age', 18, 92)
balance = st.number_input('Balance', min_value=0.0, step=0.01)
credit_score = st.number_input('Credit Score', min_value=0, step=1)
exited = st.selectbox('Exited', [0, 1])  # Use selectbox for binary options
...
gender_encoded = label_encoder_gender.transform([gender])[0]  # Encode "Male" or "Female" to 0 or 1
